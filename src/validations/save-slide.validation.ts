...
export class SaveSlideValidation {
    ...
    private async validateBackgroundImage() {
        ...
        const matchingImages = await this.imageRepository.findBy({ title: `${this.slide.title}_${this.slide.bgImage.title}_${this.slide.language.acronym.toLowerCase()}` })
    ...
    private async validateImage() {
        ...
        const matchingImages = await this.imageRepository.findBy({ title: `${this.slide.title}_${this.slide.image.title}_${this.slide.language.acronym.toLowerCase()}` })
